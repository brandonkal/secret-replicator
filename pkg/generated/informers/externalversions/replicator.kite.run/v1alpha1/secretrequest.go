	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ReplicatorV1alpha1().SecretRequests(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ReplicatorV1alpha1().SecretRequests(namespace).Watch(options)
			},
		},
		&replicatorkiterunv1alpha1.SecretRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *secretRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&replicatorkiterunv1alpha1.SecretRequest{}, f.defaultInformer)
}
